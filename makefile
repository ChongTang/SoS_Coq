...
# coq_makefile -o makefile core_config.v env_condition.v hadoop_config.v hdfs_config.v mapred_config.v other_rm.v resource_mgr.v testing.v util.v yarn_config.v 
#
