...
# coq_makefile -o makefile *.vcore_config.v *.venv_condition.v *.vhadoop_config.v *.vhdfs_config.v *.vmapred_config.v *.vother_rm.v *.vresource_mgr.v *.vtesting.v *.vutil.v *.vyarn_config.v 
#
...
.merlin:
	...
	@echo "B D:\Dropbox\FSE18\Formal_confspace\SoS_Coq" >> .merlin
	@echo "S D:\Dropbox\FSE18\Formal_confspace\SoS_Coq" >> .merlin
