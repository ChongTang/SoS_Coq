...
# coq_makefile core_config.v env_condition.v foo.v hadoop_config.v hdfs_config.v mapred_config.v resource_mgr.v testing.v util.v yarn_config.v 
#
...
.merlin:
	...
	@echo "B /Users/sullivan/Chong/SoS_Coq" >> .merlin
	@echo "S /Users/sullivan/Chong/SoS_Coq" >> .merlin
