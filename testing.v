...
Definition total_mem := 8192.

(*
Configuration parameter values.

These parameters are in mapred-site.xml
*)
Definition my_mapreduce_map_cpu_vcores := 4%Z.
Definition my_mapreduce_map_memory_mb := 1024%Z.
Definition my_mapred_child_java_opts := mk_java_opts 200%Z M. 
Definition my_mapreduce_map_java_opts := mk_java_opts 200%Z M. 
Definition my_mapreduce_reduce_java_opts := mk_java_opts 2560%Z M.
Definition my_mapred_map_output_compression_type := "BLOCK".
Definition my_mapreduce_ifile_readahead := true.
Definition my_mapreduce_ifile_readahead_bytes := 4194304%Z.
Definition my_mapreduce_input_fileinputformat_split_maxsize := 268435456%Z.
...
Definition my_mapreduce_job_speculative_retry__after__no__speculate := 1000%Z.
Definition my_mapreduce_job_speculative_retry__after__speculate := 15000%Z.
...
Definition my_mapreduce_job_split_metainfo_maxsize := 10000000%Z.
...
Definition my_mapreduce_jobtracker_expire_trackers_interval := 600000%Z.
...
Definition my_mapreduce_reduce_shuffle_retry__delay_max_ms := 60000%Z.
Definition my_mapreduce_shuffle_max_connections := 0%Z.
Definition my_mapreduce_shuffle_max_threads := 0%Z.
Definition my_mapreduce_shuffle_transfer_buffer_size := 131072%Z.
Definition my_mapreduce_task_combine_progress_records := 10000%Z.
Definition my_mapreduce_task_io_sort_factor := 10%Z.
Definition my_mapreduce_task_io_sort_mb := 100%Z.
Definition my_mapreduce_task_merge_progress_records := 10000%Z.
...
Definition my_mapreduce_tasktracker_taskmemorymanager_monitoringinterval := 5000%Z.
...
In Hadoop, this configuration should go into mapred-site.xml
*)
...
These parameters are in hdfs-site.xml
*)
...
These parameters are in core-site.xml
*)
...
Definition my_io_seqfile_compress_blocksize := 1000000%Z.
Definition my_io_seqfile_sorter_recordlimit := 1000000%Z.
Definition my_ipc_maximum_data_length := 67108864%Z.
...
(*
Define a configuation for YARN sub-component.

These parameters are in yarn-site.xml
*)
Definition my_yarn_app_mapreduce_am_command__opts := mk_java_opts 1024%Z M.
...
Definition my_yarn_nodemanager_resource_cpu__vcores := -1%Z.
Definition my_yarn_nodemanager_resource_memory__mb := -1%Z.
...
Definition my_yarn_scheduler_maximum__allocation__mb := 8192%Z.
