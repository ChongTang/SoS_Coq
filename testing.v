...
Definition my_mapreduce_job_speculative_minimum__allowed__tasks := 10.
Definition my_mapreduce_job_speculative_retry__after__no__speculate := 100.
...
Definition my_mapreduce_reduce_cpu_vcores := 1.
...
Definition my_apreduce_tasktracker_indexcache_mb := 10.
Definition my_mapreduce_tasktracker_map_tasks_maximum := 2.
Definition my_mapreduce_tasktracker_reduce_tasks_maximum := 2.
Definition my_mapreduce_tasktracker_taskmemorymanager_monitoringinterval := 500.
...
Definition my_fs_namenode_handler_count := 10.
Definition my_dfs_replication := 3.
...
Definition my_yarn_app_mapreduce_am_containerlauncher_threadpool__initial__size := 10.
Definition my_yarn_app_mapreduce_am_job_task_listener_thread__count := 30.
Definition my_yarn_app_mapreduce_am_resource_cpu__vcores := 1.
Definition my_yarn_app_mapreduce_am_resource_mb := 1536.
Definition my_yarn_nodemanager_container__manager_thread__count := 20.
Definition my_yarn_nodemanager_localizer_client_thread__count := 5.
Definition my_yarn_nodemanager_localizer_fetch_thread__count := 4.
Definition my_yarn_nodemanager_resource_cpu__vcores := 0.
Definition my_yarn_nodemanager_resource_memory__mb := 0.
Definition my_yarn_nodemanager_resource_percentage__physical__cpu__limit := 100. (*100 means 100%*)
...
Definition my_yarn_resourcemanager_admin_client_thread__count := 1.
Definition my_yarn_resourcemanager_amlauncher_thread__count := 50.
Definition my_yarn_resourcemanager_client_thread__count := 50.
Definition my_yarn_resourcemanager_resource__tracker_client_thread__count := 50.
...
Definition my_yarn_resourcemanager_scheduler_client_thread__count := 50.
...
Definition my_yarn_scheduler_increment__allocation__mb := 512.
Definition my_yarn_scheduler_maximum__allocation__mb := 819.
Definition my_yarn_scheduler_maximum__allocation__vcores := 1.
Definition my_yarn_scheduler_minimum__allocation__mb := 1024.
Definition my_yarn_scheduler_minimum__allocation__vcores := 1.
